...
player createDiaryRecord ["Diary", ["Credits","
	<br/>BMR Mission and master files Author - Jigsor =BMR=
	<br/>Insurgency 40K Verson Author - Hayden
	...
	<br/>Factions, some maps, and enemy spawn modified by Hayden
	<br/>Stream - for Weapon Eventhandler Framework mod
	<br/>TIOW Group - for There is Only War Mod
"]];
...
player createDiaryRecord ["Diary", ["Briefing","Gather Intel on Ammo Cache location by picking up suitcases. Destroy Ammo Caches with satchel or demo charges and Earn a vehicle reward of your choice. Clear all red zones of enemy forces. Complete random objectives. Get Some! NOTICE Jigsor is not apart of this project and as such can not provide support on any issues or questions regarding this version of Insurgency"]];