...
switch (INS_op_faction) do {
	...
	case 22: {
	// 40K Choas (@CBA_A3;@There_is_Only_War_Mod_-_Release_5_BETA;@Weapon_Eventhandler_Framework_version_1.2)
		_requiredAddons = ["CBA_main","TIOWM_APCs","Test_Tank_01","WHtracked_TIOW_LR_Battlecannon","WHturret","Renegades_Foot","TIOW_Comissar","TIOWSpaceMarines","Sentinel_addons","Valkyrie","TIOW40k_Scenery","TIOW_OCC_Vegetation","WHObjects3","TIOW_structures","WHObjects","WHObjects2"];
		if ({isClass(configFile >> "cfgPatches" >> _x)} count _requiredAddons == count _requiredAddons) then {
			activateAddons ["CBA_main","TIOWM_APCs","Test_Tank_01","WHtracked_TIOW_LR_Battlecannon","WHturret","Renegades_Foot","TIOW_Comissar","TIOWSpaceMarines","Sentinel_addons","Valkyrie","TIOW40k_Scenery","TIOW_OCC_Vegetation","WHObjects3","TIOW_structures","WHObjects","WHObjects2"];
			[EAST]execVM "eos\OpenMe.sqf";
		}else{INS_mod_missing = true;};
	};
};
