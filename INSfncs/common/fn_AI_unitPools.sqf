...
if (_opposingArmies in [2,3]) then {
	...
	INS_Op4_stat_weps = ["I_GMG_01_high_F","I_HMG_01_high_F","I_Mortar_01_F","I_static_AT_F","I_static_AA_F","I_GMG_01_F"];
...
// 40K - Chaos
if (_opposingArmies isEqualTo 22) then {
	INS_Op4_side = EAST;
	INS_men_list = ["TIOW_O_Ren_BL_Engineer","TIOW_Cultist7_O","TIOW_Cultist6_O","TIOW_Cultist2_O","TIOW_Cultist5_O","TIOW_Cultist3_O","TIOW_Cultist4_O","TIOW_Cultist_O","TIOW_O_Ren_BL_Crew","TIOW_O_Ren_BL_Vox","TIOW_Tactical_WB_1_Chaos","TIOW_HeavyBolter_WB_4","TIOW_Meltagunner_WB_3","TIOW_Plasmagunner_WB_5"];
	INS_Op4_medic = "TIOW_Cultist7_O";
	INS_Op4_Eng = "TIOW_O_Ren_BL_Engineer";
	INS_Op4_pilot = ["TIOW_O_Ren_BL_Vox","TIOW_O_Ren_BL_Engineer"];
	INS_Op4_Veh_Light = ["Sentinel_LC_Possessed_0_BL","Sentinel_HB_Possessed_0_BL","Sentinel_AC_Possessed_0_BL","TIOW_RenegadeTrojan_Black_OP","TIOW_Centaur_01_Renegade_BL_OP"];
	INS_Op4_Veh_Tracked = ["TIOW_Renegade_LR_Punisher_Black_OP","TIOW_Renegade_LR_Executioner_Black_OP","TIOW_Renegade_LR_Annihilator_Black_OP"];
	INS_Op4_Veh_Support = ["Sentinel_HB_Possessed_0_BL","Sentinel_AC_Possessed_0_BL"];
	INS_Op4_Veh_AA = ["TIOW_RenegadeHydra_Black"];
	INS_Op4_helis = ["Valkyrie_Possessed_BL_O"];
	INS_Op4_fixedWing = [];
	INS_Op4_stat_weps = ["TIOW_IG_MissileLauncher_AA_RenBlack_OP","TIOW_IG_MissileLauncher_AT_RenBlack_OP","TIOW_IG_Autocannon_RenBlack_OP","TIOW_IG_HeavyBolter_RenBlack_OP","TIOW_IG_Lascannon_RenBlack_OP","TIOW_IG_Mortar_RenBlack_OP"];
	INS_civlist = ["LIB_CIV_Assistant","LIB_CIV_Assistant_2","LIB_CIV_Citizen_1","LIB_CIV_Citizen_2","LIB_CIV_Citizen_3","LIB_CIV_Citizen_4","LIB_CIV_Citizen_5","LIB_CIV_Citizen_6","LIB_CIV_Citizen_7","LIB_CIV_Citizen_8","LIB_CIV_Doctor","LIB_CIV_Functionary_4","LIB_CIV_Functionary_1","LIB_CIV_Functionary_2","LIB_CIV_Functionary_3","LIB_CIV_Priest","LIB_CIV_Rocker","LIB_CIV_SchoolTeacher","LIB_CIV_SchoolTeacher_2","LIB_CIV_Villager_1","LIB_CIV_Villager_4","LIB_CIV_Villager_2","LIB_CIV_Villager_3","LIB_CIV_Woodlander_1","LIB_CIV_Woodlander_2","LIB_CIV_Woodlander_3","LIB_CIV_Woodlander_4","LIB_CIV_Worker_3","LIB_CIV_Worker_4","LIB_CIV_Worker_1","LIB_CIV_Worker_2"];
	INS_civ_Veh_Car = ["LIB_GazM1","LIB_GazM1_SOV","LIB_GazM1_FFI","LIB_Zis5v_w","LIB_Zis5v"];
	INS_civ_Veh_Utl = ["LIB_Zis6_Parm","LIB_Zis5v_Fuel","LIB_Zis5v_Med"];
};
...
private _gridMarkerUnitPools = {
	...
	switch (_faction) do {
		...
		case 8: {// EAST FIA FACTION
			...
			_uavPool=	[];
			_stPool=	["O_G_Mortar_01_F","O_G_Mortar_01_F","I_GMG_01_high_F","I_HMG_01_high_F","I_HMG_01_F","I_static_AT_F","I_static_AA_F","I_GMG_01_F"];
		...
		case 31: {// 40K Chaos
			_InfPool=	["TIOW_O_Ren_BL_Engineer","TIOW_Cultist7_O","TIOW_Cultist6_O","TIOW_Cultist2_O","TIOW_Cultist5_O","TIOW_Cultist3_O","TIOW_Cultist4_O","TIOW_Cultist_O","TIOW_O_Ren_BL_Crew","TIOW_O_Ren_BL_Vox","TIOW_Tactical_WB_1_Chaos","TIOW_HeavyBolter_WB_4","TIOW_Meltagunner_WB_3","TIOW_Plasmagunner_WB_5"];
			_ArmPool=	["TIOW_Renegade_LR_Punisher_Black_OP","TIOW_Renegade_LR_Executioner_Black_OP","TIOW_Renegade_LR_Annihilator_Black_OP"];
			_MotPool=	["Sentinel_LC_Possessed_0_BL","Sentinel_HB_Possessed_0_BL","Sentinel_AC_Possessed_0_BL","TIOW_Centaur_01_Renegade_BL_OP"];
			_ACHPool=	["Valkyrie_Possessed_BL_O"];
			_CHPool=	["Valkyrie_Possessed_BL_O"];
			_uavPool=	[];
			_stPool=	["TIOW_IG_MissileLauncher_AA_RenBlack_OP","TIOW_IG_MissileLauncher_AT_RenBlack_OP","TIOW_IG_Autocannon_RenBlack_OP","TIOW_IG_HeavyBolter_RenBlack_OP","TIOW_IG_Lascannon_RenBlack_OP","TIOW_IG_Mortar_RenBlack_OP"];
			_shipPool=	["O_Boat_Transport_01_F"];
			_diverPool=	["TIOW_O_Ren_BL_Engineer","TIOW_Cultist7_O","TIOW_Cultist6_O","TIOW_Cultist2_O","TIOW_Cultist5_O","TIOW_Cultist3_O","TIOW_Cultist4_O","TIOW_Cultist_O","TIOW_O_Ren_BL_Crew","TIOW_O_Ren_BL_Vox"];
			_crewPool=	["TIOW_O_Ren_BL_Crew","TIOW_Cultist4_O","TIOW_Cultist7_O","TIOW_Cultist6_O","TIOW_O_Ren_BL_Engineer"];
			_heliCrew=	["TIOW_O_Ren_BL_Vox","TIOW_O_Ren_BL_Engineer"];
			_issueNVG= false;
		};
	};
...
switch (_opposingArmies) do {
	...
	// 40K Chaos (@CBA_A3;@There_is_Only_War_Mod_-_Release_5_BETA;@Weapon_Eventhandler_Framework_version_1.2)
