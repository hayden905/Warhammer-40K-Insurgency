...
INS_intro = {
	...
	private _text = [  [format["%1", name player],"color='#F73105'"], ["", "<br/>"], ["Welcome to", "color='#F73105'"], ["", "<br/>"], [format["Insurgency Warhammer 40K %1", toUpper (worldName)], "color='#0059B0' font='PuristaBold'"] ];
...
INS_intro_op4 = {
	...
	_dd params ["_dawn","_dusk"];
	if (daytime > (_dusk + 1) || daytime < (_dawn - 1)) then {camUseNVG true};
	_text = [  [format["%1", name player],"color='#F73105'"], ["", "<br/>"], ["Welcome to", "color='#F73105'"], ["", "<br/>"], [format["Insurgency Warhammer 40K  %1", toUpper (worldName)], "color='#0059B0' font='PuristaBold'"] ];
